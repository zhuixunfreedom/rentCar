	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/order/update"
				...
				<input type="hidden" name="operator" value="${order.operator}">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control"
								value="${order.orderNumber}" name="orderNumber" readonly="readonly">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="dateOfApplication" value="${order.dateOfApplication}">
							</div>
						</div>
						...
						<div class="col-md-2 title">出发国家</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control"
								value="中国" name="cityName">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a6" value="${order.departureDate}" name="departureDate">
							</div>
						</div>
						<div class="col-md-2 title">出游人数</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control"
								value="${order.orderDesc.split("出行人数：")[1]}" name="peopleCount">
						</div>
				...
				<c:if test="${orders.orderStatus==1}">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data text">在线支付-<input type="text" value="${order.pay}" name="payType"></div>
