					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								placeholder="产品编号" value="${product.productNumber}"
								readonly="readonly">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="departureDate"
									value="${product.departureDate}">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="departureCity"
								placeholder="出发城市" value="${product.departureCity}">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="status">
								<c:if test="${product.status=='关闭'}">
									<option value="关闭" selected="selected">关闭</option>
									<option value="开启" >开启</option>
								</c:if>
								<c:if test="${product.status=='开启'}">
									<option value="关闭" >关闭</option>
									<option value="开启" selected="selected">开启</option>
								</c:if>
								<c:if test="${product.status!='关闭'&&product.status!='开启'}">
									<option value="关闭" selected="selected">关闭</option>
									<option value="开启" >开启</option>
								</c:if>
							</select>
